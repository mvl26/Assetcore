...
Reference: `CONVENTIONS.md §40`, `assetcore-audit` Pillar 9, `docs/res/AssetCore_Test_Plan_NextRound_1_Analysis.md` §3.
...
Reference: `CONVENTIONS.md §44`, `docs/res/AssetCore_Test_Plan_NextRound_1_Analysis.md` §3 RC-02.
