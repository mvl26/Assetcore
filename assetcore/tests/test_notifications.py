...
Run: bench --site miyano run-tests --module assetcore.tests.test_notifications
...
class TestNotifyAssignment(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
...
class TestNotifyApprovalPending(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
...
class TestEmailToggle(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        _ensure_user(_ASSIGNEE)
...
class TestNotifyIncidentCreated(unittest.TestCase):
...
class TestNotifyCalibrationDue(unittest.TestCase):
...
class TestRenderEmailTemplate(unittest.TestCase):
...
class TestDispatchThreadsReference(unittest.TestCase):
...
class TestDeliveryKpiRepo(unittest.TestCase):
...
class TestDeliveryKpiService(unittest.TestCase):
...
class TestDeliveryKpiPermission(unittest.TestCase):
...
class TestStateIsEscalation(unittest.TestCase):
...
class TestNotifyEscalation(unittest.TestCase):
...
class TestSlaTier(unittest.TestCase):
...
class TestSlaRecipients(unittest.TestCase):
...
class TestRunSlaBreachScan(unittest.TestCase):
