...
class TestImm16Base(FrappeTestCase):
...
class TestChecklistFindingStatusResultMap(FrappeTestCase):
...
class TestCAPAFromIncidentChain(FrappeTestCase):
...
class TestLLBE1Heatmap417(FrappeTestCase):
...
class TestComputeComplianceRateSoT(FrappeTestCase):
...
class TestFindingWorkflowInvariant(FrappeTestCase):
...
class TestCapaWorkflowInvariant(FrappeTestCase):
...
class TestMrWorkflowInvariant(FrappeTestCase):
...
class TestAuditWorkflowInvariant(FrappeTestCase):
