...
Run: bench --site miyano run-tests --module assetcore.tests.guards.test_oas_d12_error_surface
"""
...
# 2026-07-14 ROOT-CAUSE FIX: baseline tuyệt đối GOM về SSoT `assetcore.tests._helpers.oas_baseline`
...
from assetcore.tests._helpers.oas_baseline import (  # noqa: E402
