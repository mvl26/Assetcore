...
Run: bench --site miyano run-tests --module assetcore.tests.guards.test_oas_d11_guest_stat
"""
...
# Mỗi lần thêm/bớt PHẢI có chủ đích + ghi ledger (assetcore/tests/_helpers/oas_baseline.py).
