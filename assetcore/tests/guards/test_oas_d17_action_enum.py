...
Run: bench --site miyano run-tests --module assetcore.tests.guards.test_oas_d17_action_enum
"""
...
from assetcore.tests._helpers.oas_baseline import (
    BASELINE_GET,
    BASELINE_GUEST,
    BASELINE_JSON_PARAM,
    BASELINE_POST,
...
class TestOasD17Invariant(unittest.TestCase):
    ...
    def test_d17_06_stats_dict_equals_baseline(self):
        ...
        #   Baseline tuyệt đối GOM về SSoT `assetcore.tests._helpers.oas_baseline` (ledger đầy đủ + open-issue [BA]).
        baseline = {
