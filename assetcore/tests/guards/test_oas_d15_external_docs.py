...
Run: bench --site miyano run-tests --module assetcore.tests.guards.test_oas_d15_external_docs
"""
...
class TestOasD16Invariant(unittest.TestCase):
    ...
    def _assert_stats(self, spec):
        ...
        #   Baseline tuyệt đối GOM về SSoT `assetcore.tests._helpers.oas_baseline` (ledger + open-issue [BA]).
