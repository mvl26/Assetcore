...
Run: bench --site miyano run-tests --module assetcore.tests.mobile_device_token.test_mobile_device_token
"""
...
class TestMobileDeviceTokenSchema(FrappeTestCase):
...
class TestMobileDeviceTokenDB(FrappeTestCase):
...
class TestMobileDeviceTokenServiceLogic(FrappeTestCase):
...
class TestMobileDeviceTokenServiceDB(FrappeTestCase):
...
class TestMobileFcmSender(FrappeTestCase):
...
class TestMobilePushDispatch(FrappeTestCase):
...
class TestMobileRegisterRateLimit(FrappeTestCase):
...
class TestMobilePushDispatchDB(FrappeTestCase):
...
class TestMobileDeviceTokenSelfScope(FrappeTestCase):
...
class TestMobileDeviceTokenDoDE3HookChain(FrappeTestCase):
...
class TestMobileDeviceTokenSelfScopeDB(FrappeTestCase):
