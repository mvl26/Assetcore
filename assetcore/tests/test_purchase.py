...
Chạy: `bench --site miyano run-tests --module assetcore.tests.test_purchase`
"""
...
class TestPurchaseCapabilityMap(unittest.TestCase):
...
class TestPurchaseGateShortCircuit(unittest.TestCase):
...
class TestMarkReceivedNoDbSet(unittest.TestCase):
...
class TestPurchaseRbacRealRoles(unittest.TestCase):
