...
Run:
    bench --site miyano run-tests --app assetcore \
        --module assetcore.tests.test_imm00_smoke
"""
...
class TestS01_CreateAssetCategory(unittest.TestCase):
...
class TestS02_CreateDepartmentAutoname(unittest.TestCase):
...
class TestS03_CreateLocationTree(unittest.TestCase):
...
class TestS04_DeviceModelClassMappingRisk(unittest.TestCase):
...
class TestS05_DeviceModelFetchPayload(unittest.TestCase):
...
class TestAssetLifecycleSmoke(unittest.TestCase):
...
class TestCAPASmoke(unittest.TestCase):
...
class TestS10_CriticalIncidentNotBlocked(unittest.TestCase):
...
class TestS11_CheckCapaOverdueScheduler(unittest.TestCase):
...
class TestS13_TechnicianScopeFilter(unittest.TestCase):
