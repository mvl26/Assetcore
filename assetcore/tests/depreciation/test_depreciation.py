...
Run:
  bench --site miyano run-tests --app assetcore \
      --module assetcore.tests.depreciation.test_depreciation
"""
...
class TestAutoGenerateScheduleOnInsert(FrappeTestCase):
...
class TestDepreciationExecutorInvariants(FrappeTestCase):
...
class TestFullyDepreciatedSoT(FrappeTestCase):
...
class TestEffectiveBookValueSoT(FrappeTestCase):
...
class TestNoInlineBookFallbackGuard(FrappeTestCase):
...
class TestClampHelpers(FrappeTestCase):
...
class TestInheritDepreciationRulesSoT(FrappeTestCase):
...
class TestComputeAllNoNPlusOne(FrappeTestCase):
...
class TestComputeAllBackfillsThenGenerates(FrappeTestCase):
...
class TestComputeAllIdempotent(FrappeTestCase):
...
class TestComputeAllRBAC(FrappeTestCase):
...
class TestInheritGrepGuardSoT(FrappeTestCase):
...
class TestRegenerateSelfHeal(FrappeTestCase):
...
class TestRegenerateNoInlineCopyGuard(FrappeTestCase):
...
class TestBulkRegenNoClobber(FrappeTestCase):
...
class TestBulkRegenNoNPlusOne(FrappeTestCase):
...
class TestBulkRegenPayload(FrappeTestCase):
...
class TestBulkRegenPreservesHistory(FrappeTestCase):
...
class TestBulkRegenIdempotent(FrappeTestCase):
...
class TestBulkRegenNoInlineCopyGuard(FrappeTestCase):
...
class _BulkRegenBase(FrappeTestCase):
