...
class TestRollupInfraStatus(FrappeTestCase):
...
class TestRollupRequirementCounts(FrappeTestCase):
...
class TestGateG04(FrappeTestCase):
...
class TestComputeCandidateScore(FrappeTestCase):
...
class TestValidateLockInAssessment(FrappeTestCase):
...
class TestSpecCtaFlags(FrappeTestCase):
...
class TestSpecApprovalEnforcement(FrappeTestCase):
...
class TestSpecWorkflowInvariant(FrappeTestCase):
...
class TestSpecAllowedActions(FrappeTestCase):
...
class TestSpecTransitionGuard(FrappeTestCase):
...
class TestSpecProfileDeadGate(FrappeTestCase):
