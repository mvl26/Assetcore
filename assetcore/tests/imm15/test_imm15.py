...
class TestImm15Base(FrappeTestCase):
...
class TestDashboardLowStockPerBin(FrappeTestCase):
...
class TestLowStockBinOverride(FrappeTestCase):
...
class TestExpiringBatches(FrappeTestCase):
...
class TestCycleCountAllowedTransitions(FrappeTestCase):
...
class TestAllocationAllowedTransitions(FrappeTestCase):
