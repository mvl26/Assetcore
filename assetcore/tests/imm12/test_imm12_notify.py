...
Run: bench --site miyano run-tests --module assetcore.tests.imm12.test_imm12_notify
"""
...
class TestImm12MessageCodes(FrappeTestCase):
...
class TestImm12CloseGateHook(FrappeTestCase):
