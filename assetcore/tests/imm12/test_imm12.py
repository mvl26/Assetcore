...
Run: bench --site miyano run-tests --module assetcore.tests.imm12.test_imm12
"""
...
class TestIncidentCreation(FrappeTestCase):
...
class TestIncidentWorkflow(FrappeTestCase):
...
class TestRCAListing(FrappeTestCase):
...
class TestIncidentCancellation(FrappeTestCase):
...
class TestRCAToCAPAAndIncidentChain(FrappeTestCase):
...
class TestIncidentApiRbac(FrappeTestCase):
...
class TestIncidentSlaEscalation(FrappeTestCase):
...
class TestIncidentDetailSlaLive(FrappeTestCase):
...
class TestGetIncidentDetailEnrich(FrappeTestCase):
...
class TestIncidentOpenStatesSoT(FrappeTestCase):
...
class TestIncidentMineScope(FrappeTestCase):
...
class TestIncidentDashboardOpenTotal(FrappeTestCase):
...
class TestIncidentStatsSeverityOpenScope(FrappeTestCase):
...
class TestChronicSoT(FrappeTestCase):
...
class TestSlaBreachKpiSoT(FrappeTestCase):
...
class TestReportIncidentCapGate(FrappeTestCase):
...
class TestReportIncidentLifecycleProvenance(FrappeTestCase):
...
class TestReportIncidentIdempotency(FrappeTestCase):
...
class TestReportIncidentHeaderParity(FrappeTestCase):
...
class TestWriteFamilyIdempotencyInvariant(FrappeTestCase):
...
class TestCorrectiveCreateCapConsistency(FrappeTestCase):
...
class TestIncidentPhotoAttach(FrappeTestCase):
...
class TestIncidentPhotoIdempotency(FrappeTestCase):
...
class TestRCAAllowedTransitions(FrappeTestCase):
...
class TestRCAStartTransition(FrappeTestCase):
...
class TestRCASubmitPrecondition(FrappeTestCase):
...
class TestRCACancelTransition(FrappeTestCase):
...
class TestRCATransitionsCapability(FrappeTestCase):
...
class TestIncidentAllowedTransitions(FrappeTestCase):
...
class TestIncidentReopen(FrappeTestCase):
...
class TestRcaWorkflowParity(FrappeTestCase):
...
class TestRCAManagerCanStart(FrappeTestCase):
...
class TestIncidentRequestRca(FrappeTestCase):
    """BR-12-24 (CR-WF-12-RCA-ENTRY) — request_rca: Resolved → RCA Required
...
class TestIncidentCloseRcaGateSSoT(FrappeTestCase):
...
class TestRCADeadlockCancelledReplacement(FrappeTestCase):
...
class TestIncidentAvailableActionsShape(FrappeTestCase):
...
class TestIncidentAvailableActionsReadOnly(FrappeTestCase):
...
class TestIncidentAvailableActionsTransition(FrappeTestCase):
...
class TestIncidentAvailableActionsCapability(FrappeTestCase):
...
class TestIncidentAvailableActionsBusinessGate(FrappeTestCase):
...
class TestIncidentAvailableActionsD9Invariant(FrappeTestCase):
...
class TestIncidentAvailableActionsReopenCollision(FrappeTestCase):
...
class TestAssetIncidentHistoryTruncation(FrappeTestCase):
...
class TestRcaSubmitEnvelope(FrappeTestCase):
...
class TestRcaValidatorSsot(FrappeTestCase):
