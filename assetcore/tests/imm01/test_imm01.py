...
Run: bench --site miyano run-tests --app assetcore --module assetcore.tests.imm01.test_imm01
...
class TestPriorityClassification(FrappeTestCase):
...
class TestValidateDeviceTarget(FrappeTestCase):
...
class TestTargetYear(FrappeTestCase):
...
class TestScoreConsistency(FrappeTestCase):
...
class TestGateG02(FrappeTestCase):
...
class TestGateG05(FrappeTestCase):
...
class TestCreateProcurementPlanGate(FrappeTestCase):
...
class TestApprovePlanGuard(FrappeTestCase):
...
class TestCreatePlanRequiresProposals(FrappeTestCase):
...
class TestPlanDetailAllowedTransitions(FrappeTestCase):
...
# ─────────────────────────────────────────────────────────────────────────────
class TestNeedsOverdueEscalation(FrappeTestCase):
...
class TestNeedsListOverdueEnrichment(FrappeTestCase):
...
# ─────────────────────────────────────────────────────────────────────────────
class TestNeedsRequestAllowedTransitions(FrappeTestCase):
...
class TestNeedsRequestApproveRejectRbac(FrappeTestCase):
...
# ─────────────────────────────────────────────────────────────────────────────
class TestNeedsPlanWorkflowSurfaceInvariant(FrappeTestCase):
...
class TestNeedsRequestWriteApiPath(FrappeTestCase):
