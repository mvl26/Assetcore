...
Run: bench --site miyano run-tests --app assetcore --module assetcore.tests.imm06.test_imm06
"""
...
class TestValidatePassingScoreRange(FrappeTestCase):
...
class TestScoreBoundsConfig(FrappeTestCase):
...
class TestValidateValidityRange(FrappeTestCase):
...
class TestComputeOverallResults(FrappeTestCase):
...
class TestSignoffCompetency(FrappeTestCase):
...
class TestGetUserCompetenciesEnrichment(FrappeTestCase):
...
class TestGetUserCompetenciesTotalTruncated(FrappeTestCase):
...
class TestArchiveOldCompetency(FrappeTestCase):
...
class TestIMMTrainer(FrappeTestCase):
...
class TestParticipantScoreRange(FrappeTestCase):
...
class TestEnrollParticipants(FrappeTestCase):
...
class TestComputeCompetencyDatesSoT(FrappeTestCase):
...
class TestSeedWriteSiteSoT(FrappeTestCase):
...
class TestComputeHooksUseSoT(FrappeTestCase):
...
class TestRecertNoDivergenceCrossPath(FrappeTestCase):
...
class TestSchedulerEligibilityInvariant(FrappeTestCase):
...
class TestListUserCompetenciesReadPath(FrappeTestCase):
...
class TestBR0613GrepGuardScopesScripts(FrappeTestCase):
...
class TestSeedWriteSiteUsesSoT(FrappeTestCase):
...
class TestExpiryPredicateSoT(FrappeTestCase):
...
class TestSessionAllowedTransitions(FrappeTestCase):
...
class TestCompleteTrainingSessionBR0608(FrappeTestCase):
...
class TestCompetencyAllowedTransitions(FrappeTestCase):
...
class TestCompetencySuspendRestore(FrappeTestCase):
...
class TestCompetencyRbacGate(FrappeTestCase):
