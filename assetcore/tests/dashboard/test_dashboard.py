...
Run:
    bench --site miyano run-tests --module assetcore.tests.dashboard.test_dashboard
"""
...
class TestDashboardPermissionAwareCount(FrappeTestCase):
    ...
    Run: bench --site miyano run-tests --module assetcore.tests.dashboard.test_dashboard
    """
