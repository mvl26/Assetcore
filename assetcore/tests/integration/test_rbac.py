...
class TestRolesCatalog(FrappeTestCase):
...
class TestCapabilityMap(FrappeTestCase):
...
class TestDocPermInvariants(FrappeTestCase):
...
class TestNoHardcodedRoleChecks(FrappeTestCase):
...
class TestCoreDocPermNoShadow(FrappeTestCase):
...
class TestCapabilityEndpoint(FrappeTestCase):
...
class TestRoleFixture(FrappeTestCase):
...
class TestWorkflowRoles(FrappeTestCase):
    BAD = {
...
class TestMigrationWipe(FrappeTestCase):
...
class TestSetUserRoles(FrappeTestCase):
...
class TestUmbrellaRole(FrappeTestCase):
...
class TestRolePrivilegeEscalation(FrappeTestCase):
...
class TestVendorScopeIsolation(FrappeTestCase):
...
class TestSystemUserReadScope(FrappeTestCase):
...
class TestPickerPermissionDecoupling(FrappeTestCase):
...
class TestDualStateFieldContract(FrappeTestCase):
...
class TestOpsmgrReadOnlyOversight(FrappeTestCase):
...
class TestRepairTechnicianCanClose(FrappeTestCase):
...
class TestPmTechnicianCanComplete(FrappeTestCase):
