...
Run:
    bench --site miyano run-tests --app assetcore \
        --module assetcore.tests.integration.test_asset_operational_history_contract
"""
...
from assetcore.tests._helpers._asset_cleanup import purge_asset, purge_assets_by_name_prefix
...
class _HistoryContractBase(FrappeTestCase):
