...
class TestRC07_AutoCalibrationSchedule(FrappeTestCase):
...
class TestRC03_04_RcaCompletedChain(FrappeTestCase):
...
class TestNEG11_CloseGateForHighIncident(FrappeTestCase):
