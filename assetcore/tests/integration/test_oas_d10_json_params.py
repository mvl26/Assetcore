...
Run: bench --site miyano run-tests --module assetcore.tests.integration.test_oas_d10_json_params
"""
...
from assetcore.tests._helpers.oas_baseline import BASELINE_TOTAL
...
class TestOasD10InvariantRegression(unittest.TestCase):
    ...
    def test_d10_07_path_count(self):
        ...
        GOM về SSoT `assetcore.tests._helpers.oas_baseline.BASELINE_TOTAL` (ledger đầy đủ + open-issue [BA]).
