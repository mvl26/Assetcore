...
Run:
    bench --site miyano run-tests --app assetcore \
        --module assetcore.tests.integration.test_install_module_map
"""
...
class TestInstallModuleMap(FrappeTestCase):
    def setUp(self) -> None:
...
class TestPruneOrphanLinkCustomFields(FrappeTestCase):
