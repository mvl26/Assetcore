...
Run:
  bench --site miyano run-tests --app assetcore \
      --module assetcore.tests.test_depreciation_oos
"""
...
from assetcore.tests._asset_cleanup import purge_asset, decommission_via_closure
...
class TestDepreciationOosPauseReschedule(unittest.TestCase):
...
class TestDepreciationOosGuards(unittest.TestCase):
...
class TestOosRestoreLifecycleLabel(unittest.TestCase):
...
class TestRestoreSourceGuards(unittest.TestCase):
