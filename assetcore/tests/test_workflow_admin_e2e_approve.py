...
Run:
  bench --site miyano run-tests --app assetcore \
      --module assetcore.tests.test_workflow_admin_e2e_approve
"""
...
class TestWorkflowAdminE2EApprove(unittest.TestCase):
...
class TestSelfApprovalLiveDB(unittest.TestCase):
