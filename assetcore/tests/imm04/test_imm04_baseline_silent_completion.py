...
Chạy: bench --site miyano run-tests --app assetcore \
    --module assetcore.tests.imm04.test_imm04_baseline_silent_completion
"""
...
class TestBaselineSilentCompletionGuard(FrappeTestCase):
...
class TestBaselineUpsertAndCount(FrappeTestCase):
