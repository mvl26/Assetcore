...
Run: bench --site miyano run-tests --app assetcore --module assetcore.tests.imm04.test_imm04
"""
...
class TestGateG05G06(FrappeTestCase):
...
class TestGateG05CardValidatorParity(FrappeTestCase):
...
class TestCountOpenNcsSSoT(FrappeTestCase):
...
class TestVR01UniqueSerial(FrappeTestCase):
...
class TestVR07ClinicalHold(FrappeTestCase):
...
class TestLogLifecycleEvent(FrappeTestCase):
...
class TestRC05AuditTrailNotEmpty(FrappeTestCase):
...
class TestAUTH05FourEyes(FrappeTestCase):
...
class TestRC06AssetAutoMint(FrappeTestCase):
...
class TestCommissioningSubmitRbac(FrappeTestCase):
...
class TestSubmitForApprovalStageRole(FrappeTestCase):
...
class TestOverdueCommissioningFilterSoT(FrappeTestCase):
...
class TestOverdueSlaLiveInvariant(FrappeTestCase):
...
class TestNoInlineOverdueLiteral(FrappeTestCase):
...
class TestSearchLinkConfigFieldsExist(FrappeTestCase):
...
class TestSearchLinkRuntime(FrappeTestCase):
...
class TestGenerateQrLabelDeepLink(FrappeTestCase):
...
class TestImm04WorkflowSurfaceIntegrity(FrappeTestCase):
...
class TestBaselineVacuousPassGuard(FrappeTestCase):
...
class TestTransitionBoardApprover(FrappeTestCase):
...
class TestTransitionBoardApproverOASContract(FrappeTestCase):
...
class TestGateStatusEnforcementParity(FrappeTestCase):
...
class TestGateG04Applicability(FrappeTestCase):
