...
Run:
    bench --site miyano run-tests --app assetcore \
        --module assetcore.tests.imm00.test_imm00_base_role
"""
...
class TestBaseRoleMandatory(FrappeTestCase):
...
class TestListUsersBaseRoleFilter(FrappeTestCase):
...
class TestBackfillBaseRole(FrappeTestCase):
...
class TestListAssignableUsers(FrappeTestCase):
