...
Run: bench --site miyano run-tests --module assetcore.tests.imm00.test_imm00_approvals_inbox
"""
...
class TestPendingApprovalsInbox(FrappeTestCase):
...
class TestInboxPendingInspectionCR42(FrappeTestCase):
    """CR-42 — NGUỒN THỨ 4: Asset Repair 'Pending Inspection' (Nghiệm thu CM).
...
class TestInboxTruncationContract(FrappeTestCase):
