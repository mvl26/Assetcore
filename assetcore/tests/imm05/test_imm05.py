...
Run: bench --site miyano run-tests --app assetcore --module assetcore.tests.imm05.test_imm05
"""
...
from assetcore.tests._helpers._asset_cleanup import purge_asset, purge_assets_created_after
...
class TestResolveAlertLevel(FrappeTestCase):
...
class TestCreateDocument(FrappeTestCase):
...
class TestApproveDocument(FrappeTestCase):
...
class TestRejectDocument(FrappeTestCase):
...
class TestListDocuments(FrappeTestCase):
...
class TestExpiredSoT(FrappeTestCase):
...
class TestDepreciationDefaults(FrappeTestCase):
...
class TestGenerateScheduleZeroPrice(FrappeTestCase):
...
class TestRunDueDepreciationInvariants(FrappeTestCase):
...
class TestFullyDepreciatedReadPath(FrappeTestCase):
...
class TestGetDocumentAllowedTransitions(FrappeTestCase):
...
class TestGetDocumentCanApprove(FrappeTestCase):
