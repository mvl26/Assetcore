...
Run: bench --site miyano run-tests --module assetcore.tests.test_imm12_sla
...
from assetcore.tests.test_imm12 import _make_asset

_RUN = str(int(time.time() * 1000))[-7:]


class TestIncidentSLA(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
