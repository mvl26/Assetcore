...
Chạy:
  ...
  bench --site miyano execute assetcore.scripts.clean_orphaned_data.dry_run

  # Chạy thật:
  bench --site miyano execute assetcore.scripts.clean_orphaned_data.run

  # Chỉ quét một DocType:
  bench --site miyano execute assetcore.scripts.clean_orphaned_data.scan_doctype \
