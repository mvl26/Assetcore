...
const STATUS_MAP: Record<string, string> = {
  ...
  'Spec Defined':    'Đã xác định ĐKT',
  'Under Review':    'Đang xét duyệt',
  Planned:           'Đã lên kế hoạch',
  'Budget Locked':   'Khóa ngân sách',
  'PO Raised':       'Đã lập PO',
  Ordered:           'Đã đặt hàng',
  Delivered:         'Đã giao hàng',
  Revised:           'Cần chỉnh sửa',
  'Tech Reviewed':   'Đã duyệt KT',
...
const COLOR_CYAN   = 'bg-cyan-100 text-cyan-800 border border-cyan-200'
const COLOR_INDIGO = 'bg-indigo-100 text-indigo-800 border border-indigo-200'
...
const STATUS_COLOR: Record<string, string> = {
  ...
  // ── Mapping Wave 2 vào hệ màu Tailwind ───────────────────────────────────
  'Spec Defined':   COLOR_CYAN,
  'Tech Reviewed':  COLOR_CYAN,
  Ordered:          COLOR_BLUE,
  'Under Review':   COLOR_INDIGO,
  Planned:          COLOR_PURPLE,
  'Budget Locked':  COLOR_PURPLE,
  'PO Raised':      COLOR_YELLOW,
  Revised:          COLOR_ORANGE,
  Released:         COLOR_GREEN,
  Fulfilled:        COLOR_GREEN,
  Delivered:        COLOR_GREEN,
}
