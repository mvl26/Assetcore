...
import { COMPONENTS } from '@/test/paths'
import DetailPageShell from '@/components/common/DetailPageShell.vue'

const SHELL_SRC = readFileSync(resolve(COMPONENTS, 'common', 'DetailPageShell.vue'), 'utf8')
...
describe('DetailPageShell — TC-UX4-13 no-fork + luật tầng (quét mã nguồn)', () => {
  ...
  it('A1 — tầng 0 giữ ĐÚNG 8 primitive, shell KHÔNG nằm trong components/ui', () => {
    ...
    // [K8] dân số: khoá BẰNG NHAU 8 primitive — mạnh hơn ngưỡng tối thiểu.
