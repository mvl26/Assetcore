...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    meta: { requiresAuth: true, title: 'Hồ sơ Khắc phục & Phòng ngừa', moduleId: 'imm16' },
  },
  {
    path: '/capas/:id',
    name: 'CAPADetail',
  ...
  },
  {
    ...
    meta: { requiresAuth: true, title: 'Phát hiện tuân thủ', moduleId: 'imm16' },
  },
  {
    ...
    props: true,
    meta: { requiresAuth: true, title: 'Chi tiết phát hiện', moduleId: 'imm16' },
  },
  {
    path: '/compliance/audits',
    name: 'InternalAuditList',
    component: () => import('@/views/compliance/InternalAuditListView.vue'),
    meta: { requiresAuth: true, title: 'Kiểm toán nội bộ', moduleId: 'imm16' },
  },
  {
    ...
    props: true,
    meta: { requiresAuth: true, title: 'Chi tiết kiểm toán nội bộ', moduleId: 'imm16' },
  },
  {
    path: '/compliance/scorecard',
    name: 'ComplianceScorecard',
    component: () => import('@/views/compliance/ScorecardView.vue'),
    meta: { requiresAuth: true, title: 'Bảng điểm tuân thủ', moduleId: 'imm16' },
  },
  {
    path: '/compliance/mr',
  ...
  },
  {
    ...
    meta: { requiresAuth: true, title: 'Bản đồ nhiệt tuân thủ', moduleId: 'imm16' },
  },
  ...
  // ─── 9b. Inventory (IMM-00 Inventory sub-domain) ────────────────────────────
  {
    ...
    meta: { requiresAuth: true, title: 'IMM Storekeeper — Tổng quan', moduleId: 'imm15' },
  },
  {
    path: '/warehouses',
    name: 'WarehouseList',
    component: () => import('@/views/inventory/WarehouseListView.vue'),
    meta: { requiresAuth: true, title: 'Danh sách Kho', moduleId: 'imm15' },
  },
  {
    ...
    props: true,
    meta: { requiresAuth: true, title: 'Chi tiết Kho', moduleId: 'imm15' },
  },
  {
    path: '/spare-parts',
    name: 'SparePartList',
    component: () => import('@/views/inventory/SparePartListView.vue'),
    meta: { requiresAuth: true, title: 'Danh mục phụ tùng', moduleId: 'imm15' },
  },
  {
  ...
  },
  {
    ...
    props: true,
    meta: { requiresAuth: true, title: 'Sửa phiếu kho', moduleId: 'imm15' },
  },
  {
    ...
    props: true,
    meta: { requiresAuth: true, title: 'Chi tiết phiếu kho', moduleId: 'imm15' },
  },
  {
    path: '/inventory/uom',
    name: 'UomConversion',
    component: () => import('@/views/inventory/UomConversionView.vue'),
    meta: { requiresAuth: true, title: 'Đơn vị tính (UOM)', moduleId: 'imm15' },
  },
  {
