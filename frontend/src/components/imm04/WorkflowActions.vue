...
// GW-2: chặn Submit nếu IMM-05 chưa compliant (chỉ áp dụng ở Clinical_Release)
  ...
  <div>
    ...
    <div v-else-if="hasActions" class="flex flex-wrap gap-3">
      ...
      <template v-else>
        ...
        <!-- GW-2 warning banner (trước nút Submit khi IMM-05 chưa compliant) -->
        <div
          v-if="gw2Block"
        ...
        >
          ...
          <span>
            <strong>GW-2 Blocked:</strong> Hồ sơ IMM-05 chưa đạt chuẩn.
        ...
        <div class="relative group">
          ...
          >
            Cần hoàn thiện hồ sơ IMM-05 trước. Vào tab "Kết quả triển khai" để xem chi tiết.
