          ...
          <div class="space-y-2">
            ...
            <template v-if="wo.status === 'Open'">
              <button class="w-full px-4 py-2.5 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors"
                @click="showAssignModal = true">Phân công KTV</button>
            </template>
            ...
            <template v-if="wo.status === 'Assigned'">
              <button class="w-full px-4 py-2.5 bg-purple-600 text-white rounded-lg text-sm font-medium hover:bg-purple-700 transition-colors"
                @click="navigateDiagnose">Bắt đầu chẩn đoán</button>
            </template>

            <!-- Diagnosing → navigate /diagnose -->
            <template v-if="wo.status === 'Diagnosing'">
              <button class="w-full px-4 py-2.5 bg-purple-600 text-white rounded-lg text-sm font-medium hover:bg-purple-700 transition-colors"
                @click="navigateDiagnose">Cập nhật chẩn đoán</button>
            </template>

            <!-- Pending Parts → navigate /parts -->
            <template v-if="wo.status === 'Pending Parts'">
              <button class="w-full px-4 py-2.5 bg-orange-600 text-white rounded-lg text-sm font-medium hover:bg-orange-700 transition-colors"
                @click="navigateParts">Quản lý vật tư</button>
            </template>
            ...
            <template v-if="wo.status === 'In Repair'">
              ...
              <button class="w-full px-4 py-2.5 bg-green-600 text-white rounded-lg text-sm font-medium hover:bg-green-700 transition-colors"
                @click="navigateChecklist">Hoàn thành sửa chữa</button>
            </template>

            <!-- Pending Inspection → navigate /checklist -->
            <template v-if="wo.status === 'Pending Inspection'">
              <button class="w-full px-4 py-2.5 bg-cyan-600 text-white rounded-lg text-sm font-medium hover:bg-cyan-700 transition-colors"
                @click="navigateChecklist">Nghiệm thu</button>
            </template>
            ...
            <template v-if="!['Completed','Cannot Repair','Cancelled'].includes(wo.status)">
              <button class="w-full px-4 py-2.5 border border-red-300 text-red-600 rounded-lg text-sm font-medium hover:bg-red-50 transition-colors"
                @click="showCannotRepairModal = true">Không thể sửa chữa</button>
            </template>
