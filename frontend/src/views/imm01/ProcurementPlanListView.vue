...
<template>
  <div class="page-container animate-fade-in">
    <div class="flex items-start justify-between mb-4">
      <div>
        ...
        <p class="text-sm text-slate-500 mt-1">
          Tổng <strong class="text-slate-700">{{ store.plans.length }}</strong> kế hoạch — gom đề xuất đã duyệt theo quý/năm.
        </p>
      </div>
    ...
    <div class="card overflow-hidden">
      ...
      <div v-if="store.plans.length" class="overflow-x-auto">
