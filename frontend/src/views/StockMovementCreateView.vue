...
import { createStockMovement, searchParts } from '@/api/inventory'
...
<template>
  <div class="page-container animate-fade-in">
    ...
    <div class="card p-5 mb-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input id="sm-ref-name" v-model="referenceName" type="text" class="form-input w-full font-mono"
    ...
    <!-- Notes -->
    <div class="card p-5 mb-4">
      <label for="sm-notes" class="form-label">Ghi chú</label>
