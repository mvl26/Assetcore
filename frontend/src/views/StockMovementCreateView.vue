  ...
  <div class="page-container animate-fade-in">
    ...
    <div class="card p-5 mb-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div v-if="needsRefSearch" class="relative">
          ...
          <input id="sm-ref-name" type="text" class="form-input w-full font-mono"
                 :value="refLabel"
        ...
        <div v-for="(row, idx) in items" :key="idx"
          ...
          <div class="col-span-12 md:col-span-5 relative">
            ...
            <div v-else class="relative">
              <input :id="`sm-part-${idx}`" type="text"
          ...
          <div class="col-span-4 md:col-span-2">
            ...
            <input :id="`sm-qty-${idx}`" v-model.number="row.qty" type="number"
          ...
          <div class="col-span-4 md:col-span-2">
            ...
            <select v-if="row._uom_options && row._uom_options.length > 1"
                    v-model="row.uom"
            ...
            <p v-if="row.uom && row._stock_uom && row.uom !== row._stock_uom && row.stock_qty !== undefined"
          ...
          <div class="col-span-4 md:col-span-2">
            ...
            <input :id="`sm-cost-${idx}`" v-model.number="row.unit_cost" type="number" min="0" step="1000"
          ...
          <div class="col-span-12 md:col-span-6">
            ...
            <input :id="`sm-row-sn-${idx}`" v-model="row.serial_no" type="text"
    ...
    <div class="card p-5 mb-4">
      <label for="sm-notes" class="form-label">
        Ghi chú
        <span v-if="referenceType === 'Manual' || movementType === 'Adjustment'"
              class="text-red-500 ml-1">*</span>
      </label>
      <textarea id="sm-notes" v-model="notes" rows="3" class="form-input w-full"
