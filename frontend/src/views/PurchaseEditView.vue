  ...
  try {
    await updatePurchase(props.name, {
      ...
      devices: validDevices.map(d => ({
        ...
        clinical_dept: d.clinical_dept, notes: d.notes,
      })),
    })
    ...
    <template v-else>
      ...
      <div v-if="!error || items.length">
        ...
        <div class="card p-5 mb-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input id="edit-date" v-model="purchaseDate" type="datetime-local" class="form-input w-full" />
            </div>
            <div>
              <label for="edit-invoice" class="form-label">Số hóa đơn / Mã PO</label>
              <input id="edit-invoice" v-model="invoiceNo" type="text" class="form-input w-full font-mono"
                     placeholder="VD: INV-2026-0001, PO-00123" />
            </div>
            <div>
              <label for="edit-delivery" class="form-label">Ngày giao hàng dự kiến</label>
              <input id="edit-delivery" v-model="expectedDelivery" type="date" class="form-input w-full" />
            </div>
          </div>
        </div>
          ...
          <div class="mb-4 p-3 rounded-lg border border-dashed border-indigo-200 bg-indigo-50/40">
            ...
            <div class="grid grid-cols-12 gap-2 items-end">
              ...
              <div class="col-span-4 md:col-span-2">
                ...
                <input id="eqa-count" v-model.number="quickCount" type="number" min="1" max="50" step="1"
                       class="form-input w-full text-sm" />
              </div>
              <div class="col-span-4 md:col-span-3">
                <label for="eqa-cost" class="text-[10px] text-slate-500 mb-1 block">Đơn giá / máy</label>
                <input id="eqa-cost" v-model.number="quickCost" type="number" min="0" step="1000"
                       class="form-input w-full text-sm" />
              </div>
              <div class="col-span-4 md:col-span-2">
                <button
          ...
          <div v-else class="space-y-3">
            <div v-for="(d, idx) in devices" :key="idx"
              ...
              <div class="col-span-6 md:col-span-2">
                ...
                <input :id="`edev-cost-${idx}`" v-model.number="d.unit_cost" type="number" min="0" step="1000"
                       class="form-input w-full text-sm" />
              </div>
              <div class="col-span-5 md:col-span-3">
                <label :for="`edev-wm-${idx}`" class="text-[10px] text-slate-500 mb-1 block">BH (tháng)</label>
                <input :id="`edev-wm-${idx}`" v-model.number="d.warranty_months" type="number" min="0" step="1"
                       class="form-input w-full text-sm" />
              </div>
              ...
              <div class="col-span-12 md:col-span-6">
                ...
                <input :id="`edev-sn-${idx}`" v-model="d.vendor_serial_no" type="text"
            ...
            <div v-for="(row, idx) in items" :key="idx"
              ...
              <div class="col-span-12 md:col-span-5 relative">
                ...
                <div v-else class="relative">
                  <input :id="`ep-part-${idx}`" type="text"
              ...
              <div class="col-span-4 md:col-span-2">
                ...
                <input :id="`ep-qty-${idx}`" v-model.number="row.qty" type="number" min="0.01"
              ...
              <div class="col-span-4 md:col-span-2">
                ...
                <input :id="`ep-cost-${idx}`" v-model.number="row.unit_cost" type="number" min="0"
        ...
        <div class="card p-5 mb-4">
          ...
          <textarea id="edit-notes" v-model="notes" rows="3" class="form-input w-full"
