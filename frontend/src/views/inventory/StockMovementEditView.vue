      ...
      <div class="card p-5 mb-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div v-if="needsRefSearch" class="relative">
            ...
            <input
id="sm-edit-ref-name" type="text" class="form-input w-full font-mono"
                   :value="refLabel"
...
v-for="r in refResults" :key="r.name"
      ...
      <div class="card p-5 mb-4">
        ...
        <div class="space-y-3">
          <div
v-for="(row, idx) in items" :key="row._key"
...
type="button"
              ...
              <div v-else class="relative">
                <input
type="text" class="form-input w-full text-sm pr-8"
...
v-else-if="activeRowIdx === idx && !searchLoading && (row._searchQuery?.length ?? 0) >= 2 && !row.spare_part"
            ...
            <div class="col-span-4 md:col-span-2">
              ...
              <input
v-model.number="row.qty" type="number" :min="movementType === 'Adjustment' ? undefined : 0.01"
...
✕
      ...
      <div class="card p-5 mb-4">
        ...
        <textarea
id="sm-edit-notes" v-model="notes" rows="3" class="form-input w-full"
