          ...
          <div class="p-6 space-y-4 overflow-y-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div class="flex items-center gap-3 pt-5">
                <input id="edit-critical" v-model="form.is_critical" type="checkbox" :true-value="1" :false-value="0" class="h-4 w-4 text-blue-600 rounded" />
                <label for="edit-critical" class="text-sm text-slate-700">Linh kiện quan trọng</label>
              </div>
              <div class="flex items-center gap-3 pt-5">
                <input id="edit-active" v-model="form.is_active" type="checkbox" :true-value="1" :false-value="0" class="h-4 w-4 text-blue-600 rounded" />
