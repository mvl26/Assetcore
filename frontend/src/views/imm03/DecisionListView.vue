...
<template>
  <div class="page-container animate-fade-in">
    <div class="flex items-start justify-between mb-4">
      <div>
        <h1 class="text-2xl font-bold text-slate-900">Quyết định mua sắm</h1>
        <p class="text-sm text-slate-500 mt-1">
          Tổng <strong class="text-slate-700">{{ store.decisions.length }}</strong> quyết định — trao thầu, ký hợp đồng, phát hành đơn hàng.
        </p>
      </div>
