...
const { clear: clearDraft } = useFormDraft('commissioning-create', form)
...
<!-- PO Reference -->
          ...
          <div class="form-group">
            ...
            <DateInput id="expected_installation_date" v-model="form.expected_installation_date" class="form-input" :class="{ 'border-red-400 ring-1 ring-red-300': fieldErrors.expected_installation_date }" @change="validateField('expected_installation_date')" />
          ...
          <div class="form-group">
            ...
            <DateInput id="reception_date" v-model="form.reception_date" class="form-input" />
          ...
          <div class="form-group">
            ...
            <DateInput id="warranty_expiry_date" v-model="form.warranty_expiry_date" class="form-input" />
          </div>
