...
// IMM-00 Inventory Dashboard — tổng quan kho vật tư
  ...
  <div class="page-container animate-fade-in">
    ...
    <div v-else-if="overview">
      ...
      <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="card p-5 hover:shadow-md cursor-pointer transition-shadow"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-6">
        ...
        <div class="card p-5">
          ...
          <div v-if="overview.low_stock_items.length === 0"
               class="text-center py-8 text-sm text-slate-400">
            ✅ Không có phụ tùng nào dưới mức min
          </div>
          <div v-else class="space-y-2.5">
            <div v-for="item in overview.low_stock_items" :key="item.spare_part"
        ...
        <div class="card p-5">
          ...
          <div class="grid grid-cols-2 gap-3">
            <div v-for="(cnt, type) in overview.movement_30d" :key="type"
          ...
          <div v-if="Object.keys(overview.movement_30d).length === 0"
               class="text-center py-8 text-sm text-slate-400">
