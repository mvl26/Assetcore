...
// IMM-06 — Depreciation & Asset Accounting
...
<template>
  <div class="page-container animate-fade-in">
        ...
        <div class="space-y-3">
          ...
          <div v-if="stats.unconfigured_count > 0" class="flex items-center gap-3">
            <div class="flex-1">
              ...
              <div class="h-2 bg-slate-100 rounded-full">
                <div class="h-2 bg-slate-300 rounded-full"
    ...
    <div class="card p-4 mb-4">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        <div>
          ...
          <input id="depr-category-filter" v-model="categoryFilter" type="text" class="form-input w-full"
    ...
    <Transition name="fade">
      <div v-if="scheduleOpen" class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4"
        ...
        <div class="bg-white rounded-2xl w-full max-w-2xl max-h-[80vh] flex flex-col shadow-2xl">
          ...
          <div class="flex items-center justify-between px-6 py-4 border-b border-slate-100">
            ...
            <button class="p-1.5 rounded-md text-slate-400 hover:text-slate-700 hover:bg-slate-100"
          ...
          <div class="overflow-y-auto flex-1 px-6 py-4">
            ...
            <div v-else-if="schedule">
              ...
              <table class="w-full text-sm">
                ...
                <tbody>
                  <tr v-for="r in schedule.schedule" :key="r.year"
