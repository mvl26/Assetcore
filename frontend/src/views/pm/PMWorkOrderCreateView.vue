  ...
  <div class="page-container animate-fade-in space-y-6">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
      ...
      <div>
        ...
        <DateInput id="due-date" v-model="form.due_date" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400" />
      </div>
