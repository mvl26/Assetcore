  ...
  <div class="page-container animate-fade-in space-y-5">
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center gap-3">
        ...
        <button class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium" @click="openCreate">+ Thêm Template</button>
      </div>
    </div>
        ...
        <tbody class="divide-y divide-gray-100">
          <tr v-for="t in items" :key="t.name" class="hover:bg-gray-50">
            ...
            <td class="px-4 py-3 text-right space-x-2 whitespace-nowrap">
              <button class="text-blue-600 text-xs font-medium" @click="openEdit(t.name)">Sửa</button>
              <button class="text-red-600 text-xs font-medium" @click="remove(t.name)">Xóa</button>
            </td>
          </tr>
        </tbody>
      </table>
