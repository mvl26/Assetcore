...
<template>
  <div class="page-container animate-fade-in">
    <div class="flex items-start justify-between mb-4">
      <div>
        <h1 class="text-2xl font-bold text-slate-900">Hồ sơ kỹ thuật</h1>
        <p class="text-sm text-slate-500 mt-1">
          Tổng <strong class="text-slate-700">{{ store.specs.length }}</strong> hồ sơ — quản lý yêu cầu kỹ thuật, so sánh thị trường, đánh giá phụ thuộc nhà cung cấp.
        </p>
      </div>
