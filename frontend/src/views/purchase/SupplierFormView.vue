...
const { clear: clearDraft } = useFormDraft('supplier-create', form, { enabled: !isEdit.value })
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <DateInput v-model="form.contract_start" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm" />
        </div>
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1">Hợp đồng đến</label>
          <DateInput v-model="form.contract_end" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm" />
        </div>
        <div>
        ...
        <div>
          ...
          <DateInput v-model="form.iso_13485_expiry" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm" />
        </div>
        <div>
        ...
        <div>
          ...
          <DateInput v-model="form.iso_17025_expiry" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm" />
        </div>
      </div>
      ...
      <div class="flex justify-end gap-2 pt-4 border-t border-gray-100">
        <button class="px-4 py-2 text-sm border border-gray-300 rounded-lg hover:bg-gray-50" @click="router.push('/suppliers')">Hủy</button>
