...
**Guard hợp đồng (`assetcore/tests/guards/test_mobile_oas.py`) — class MỚI `TestMobilePmAvailableActionsParity`, 9 TC `cr77_a..i`:**
...
|---|---|---|---|
| `_EXPECTED_TEST_COUNT` | `assetcore/tests/guards/test_mobile_oas.py:212` | 942 | 951 |
| `_GUARD_SUITE_EXPECTED["test_mobile_oas.py"]` | `assetcore/tests/guards/test_mobile_docset.py:781` | 942 | 951 |
| `_GUARD_SUITE_SUM` | `assetcore/tests/guards/test_mobile_docset.py:949` | 1085 | 1094 |
| `_MOBILE_OAS_TOTAL` | `assetcore/tests/guards/test_mobile_docset.py:1138` | 1111 | 1120 |
...
2. **[BE]** `assetcore/tests/imm08/test_imm08.py`: class `TestPmAvailableActions` — INV-PMCTA-1..10 (`07 §IX`), **RED-before** với ít nhất INV-PMCTA-4 (`Cancelled`) và INV-PMCTA-6 (A5).
...
5. **DoD:** `bench --site miyano run-tests --module assetcore.tests.imm08.test_imm08` · `...test_mobile_oas` · `...test_mobile_docset` (timeout tool **≥600000ms**, module-isolated) + `vue-tsc --noEmit` 0 lỗi + `vitest run` file test mới. **KHÔNG curl** (BLOCKED-RELOAD gunicorn `--preload`), **KHÔNG `bench migrate`**, **KHÔNG `npm run build`**.
...
6. **DoD:** `bench --site miyano run-tests --module assetcore.tests.imm08.test_imm08` · `...test_imm09` ·
