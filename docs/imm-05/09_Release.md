...
| API endpoint | 14 | `list, get, create, update, approve, reject, get_asset_docs, dashboard_stats, expiring, compliance_by_dept, history, create_request, get_requests, mark_exempt` |
...
| LOC Controller (`asset_document.py`) | ~400 | Bao gồm cả service logic (chưa tách) |
| LOC API (`api/imm05.py`) | ~200 | 14 endpoints |
| LOC Tasks (`tasks.py` — imm05) | ~150 | 3 scheduler functions |
