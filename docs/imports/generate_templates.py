...
def make_assets():
    ...
    build_sheet(wb, "Danh sách tài sản", [
        ...
        {"name": "asset_code", "label": "Mã tài sản (nội bộ)", "required": False, "width": 22,
         "desc": "Mã quản lý nội bộ duy nhất. Để trống = tự sinh.", "example": "TS-2024-001"},
        {"name": "asset_category", "label": "Danh mục tài sản", "required": True, "width": 28,
        ...
        {"name": "manufacturer_sn", "label": "Số serial (NSX)", "required": False, "width": 22,
         "desc": "Số serial do nhà sản xuất cấp (Serial Number).", "example": "SN-GE-2023-88712"},
