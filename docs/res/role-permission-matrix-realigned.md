...
- `docs/res/role-redesign-module-based.md` — Thiết kế chi tiết mô hình 4 System Role + 26 Domain Role (Manager/User × 13 module)
...
- `docs/res/user-scope-filter-analysis.md` — Phân tích cô lập dữ liệu (Vendor / Department scope)
