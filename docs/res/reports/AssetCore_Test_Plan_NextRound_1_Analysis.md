...
**Nguồn:** `docs/res/reports/AssetCore_Test_Plan_NextRound_1.xlsx`
...
|----|-----|---------|--------------------------------|
| AUTH-01 | P1 | KTV NCC bị cô lập theo Asset/WO | Đây là kiểm chứng **user-scope filter** đã được phân tích trong `docs/res/rbac/user-scope-filter-analysis.md`. Nếu filter chỉ áp ở FE list mà không ở BE detail/API, truy cập trực tiếp URL sẽ lộ dữ liệu asset/WO không thuộc phạm vi giao việc. Cần test: (a) FE chặn nút, (b) BE chặn API, (c) detail-by-name vẫn chặn. |
...
2. Tham chiếu chéo với `docs/res/rbac/user-scope-filter-analysis.md` và `docs/res/rbac/role-redesign-module-based.md`.
...
- **Liên quan:** `docs/res/rbac/user-scope-filter-analysis.md`.
...
| AUTH-01/10 (KTV NCC + IDOR) | `docs/res/rbac/user-scope-filter-analysis.md` | Đang phân tích — cần kết luận và fix |
| RC-09 (Phiếu chờ duyệt 3 vs 0) | `docs/res/rbac/user-scope-filter-analysis.md` | Cần consolidate scope |
...
**Cross-link:**
- Test plan gốc: `docs/res/reports/AssetCore_Test_Plan_NextRound_1.xlsx`
- User-scope analysis: `docs/res/rbac/user-scope-filter-analysis.md`
- Role redesign: `docs/res/rbac/role-redesign-module-based.md`
