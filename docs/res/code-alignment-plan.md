...
> **Status: ✅ DoD PASS (2026-05-11)** — chi tiết tại `docs/res/dod-verification-report.md`.
...
| 2026-05-11 | **Sprint 6** | DoD verification: full test run, FE typecheck/lint/build, anti-pattern scan, audit chain verify. Fix `validate_scorecard_immutability` stub. Generated `docs/res/dod-verification-report.md`. **DoD §7 PASS** (1 manual UAT item pending). |
