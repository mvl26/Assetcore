...
| Wave | 2 |
| Trạng thái | Implemented — BE + FE đã scaffold (Wave 2 build) |
...
| 05 API_Specification | [`05_API_Specification.md`](./05_API_Specification.md) | ✅ Có — envelope chuẩn `{success, data}` — 23 endpoints |
...
- [`05_API_Specification.md`](./05_API_Specification.md) — 23 endpoints, envelope `{success, data}`, TypeScript types
...
- [x] Bổ sung **`05_API_Specification.md`** — 23 endpoints + envelope chuẩn {success,data}
...
- Codebase ground truth (BE): `assetcore/services/imm06.py` (1323 LOC) · `assetcore/api/imm06.py` (240 LOC, **23** `@frappe.whitelist()` endpoints)
