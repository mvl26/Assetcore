...
| Bất biến `INV-UX3-24…29` + test `TC-UX3-39` | [`§14.5` / `§14.6`](../ui-ux/02_LIST_PAGE_SHELL.md) |
| Guard adoption CHỈ-GIẢM (`AC-UX-070`) | `frontend/src/views/listShellAdoption.test.ts` |

- **Route thuộc lô 3 của module này:** `/inventory/cycle-counts`
- **File view:** `views/inventory/CycleCountListView.vue`
